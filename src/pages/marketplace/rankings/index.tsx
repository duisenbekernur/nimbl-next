            ...
            <div className={styles.table_content_inner}>
                <div className={styles.sidebar_sort}>
                    <div className={styles.sort_byCategory}>
                        ...
                        <Image className={styles.byCategory_icon} src={arrowDownSvg} alt="" style={{
                            width: '20px',
                            height: '15px'
                       }}/>
                    </div>
                    ...
                    <div className={styles.header_tabs}>
                        <div className={styles.header_tab}>View as Grid</div>
                        <div className={styles.header_tab}>View as List</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div className={styles.card_loop}>
                <div className={styles.card_box}>
                    <div className={styles.video_header}>
                        <Image className={styles.video_header_logo} src={channelImg} alt="" />
                        <div className={styles.video_pause}>
                            <Image className={styles.video_box_pause} src={pauseImg} alt=""/> 
                        </div>  
                    </div>
                    <div className={styles.video_body}>
                        <div className={styles.box_title} style={{color: '#fff'}}>@Yellow Stone</div>
                        <div className={styles.box_buttons}>
                            <div className={styles.box_button}  style={{color: '#fff'}}>
                                <div className={styles.box_button_header} style={{color: '#fff' }}>
                                    <div className={styles.count}>500K</div>
                                </div>
                                    <div className={styles.box_button_footer}>members</div>
                                </div>
                            <div className={styles.box_button}>
                                <div className={styles.box_button_title}>134 NMBL</div>
                                <div className={styles.box_button_footer} style={{color: '#fff' }}>floor price</div>
                            </div>
                        </div> 
